...
Follow the process in one of the E2E solutions. For a list of available E2E Solutions [click here](https://github.com/boconnor2017/vmw-e2e/blob/master/solutions/README.md). For API references [click here](https://github.com/boconnor2017/vmw-e2e/blob/master/api/README.md).
