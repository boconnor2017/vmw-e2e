...
An E2E solution should define the required people and process to generate the expected results of a product. If an artifact does not incorporate people, process, product it will not be accepted as an E2E solution. 
